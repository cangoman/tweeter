...
<img src="https://github.com/cangoman/tweeter/blob/master/docs/medium-screen.png?raw=true" alt="Screentshot of the page in a medium screen, with the new tweet box visible" width="62%">

<img src="https://github.com/cangoman/tweeter/blob/master/docs/small-screen-scrolled.png?raw=false" alt="Screentshot of the page in a medium screen, with the new tweet box visible" width="34%" >
